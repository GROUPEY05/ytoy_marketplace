...
//       let url = `/api/admin/utilisateurs?page=${currentPage}`;
//       if (selectedRole !== 'all') {
...
//       } else {
//         // Données factices en cas d'erreur ou de réponse vide
//         setUsers([
//           { id: 1, nom: 'Dupont', prenom: 'Jean', email: 'jean.dupont@example.com', role: 'acheteur', status: 'active', created_at: '2023-01-15' },
//           { id: 2, nom: 'Martin', prenom: 'Sophie', email: 'sophie.martin@example.com', role: 'vendeur', status: 'active', created_at: '2023-02-20' },
//           { id: 3, nom: 'Dubois', prenom: 'Pierre', email: 'pierre.dubois@example.com', role: 'administrateur', status: 'active', created_at: '2023-03-10' },
//           { id: 4, nom: 'Leroy', prenom: 'Marie', email: 'marie.leroy@example.com', role: 'acheteur', status: 'banned', created_at: '2023-01-25' },
//           { id: 5, nom: 'Moreau', prenom: 'Thomas', email: 'thomas.moreau@example.com', role: 'vendeur', status: 'pending', created_at: '2023-02-28' },
//         ]);
//         setTotalPages(1);
//       }
//     } catch (error) {
...
//       await apiClient.post(`/api/admin/utilisateurs/${userId}/ban`);
...
//       alert(`L'utilisateur a été ${newStatus === 'banned' ? 'banni' : 'réactivé'} avec succès.`);
//     } catch (error) {
