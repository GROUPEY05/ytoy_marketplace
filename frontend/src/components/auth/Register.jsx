                  ...
                  <div className="col-md-6">
                    <div className="form-floating mb-3">
                      <input
                        ...
                        required
                      />
                      <label htmlFor="mot_de_passe_confirmation">Confirmez le mot de passe</label>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="acheteur-fields">
                    <div className="card mb-4 border-primary">
                      <div className="card-header bg-light">
                        <h5 className="mb-0 text-primary">Informations acheteur</h5>
                      </div>
                      <div className="card-body">
                        <div className="form-floating mb-3">
                          <input
                    ...
                    <div className="card mb-4 border-success">
                      ...
                      <div className="card-body">
                        <div className="form-floating mb-3">
                          <input
                            type="text"
                            className={`form-control ${errors.nom_boutique ? 'is-invalid' : ''}`}
                            id="nom_boutique"
                            name="nom_boutique"
                          ...
                          {errors.nom_boutique && <div className="invalid-feedback">{errors.nom_boutique}</div>}
                        </div>
                        <div className="form-floating mb-3">
                          <textarea
            ...
            <div className="card-footer text-center py-3">
              <div className="small">
                <p className="mb-0">
                  ...
                  <a href="/login" className="text-decoration-none ms-1">Connectez-vous</a>
                </p>
              </div>
            </div>
          </div>
