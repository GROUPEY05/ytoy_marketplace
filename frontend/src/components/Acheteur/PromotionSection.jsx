            ...
            <Card className="promotion-card h-100 shadow-sm">
              ...
              <Card.Body>
                ...
                <div className="price-container mb-2">
                  <span className="promo-price">{item.prix_promo.toLocaleString()} FCFA</span>
                  <span className="original-price">{item.prix_normal.toLocaleString()} FCFA</span>
                </div>
                <div className="discount-badge">-{Math.round(item.pourcentage_reduction)}%</div>
